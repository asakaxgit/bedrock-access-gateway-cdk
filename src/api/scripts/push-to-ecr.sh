...
build_and_push_images() {
    ...
    local DOCKERFILE_PATH=${4:-"../docker/Dockerfile_ecs"}  # Parameter for Dockerfile path, default is "../src/Dockerfile_ecs"
...
build_and_push_images "bedrock-proxy-api" "$TAG" "false" "../docker/Dockerfile"
